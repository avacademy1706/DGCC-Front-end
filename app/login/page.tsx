      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-11 py-9 text-center">
        ...
        >
          ...
          <span
            style={{
              backgroundImage:
                "linear-gradient(90deg, #FF6F00 0%, #F59E0B 100%)",
          ...
          >
            ...
            {success ? (
              ...
              <form onSubmit={handleSubmit} noValidate>
                ...
                <p
                  className="mb-7 text-[13px] leading-6"
                  style={{ color: "#64748B" }}
                >
                  ...
                  onMouseEnter={(e) => {
                    if (!loading) {
                      ...
                      e.currentTarget.style.boxShadow =
                        "0 16px 32px rgba(255,111,0,0.28)";
                    }
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.background = "#FF6F00";
                    e.currentTarget.style.boxShadow =
                      "0 12px 28px rgba(255,111,0,0.24)";
                  }}
                >
                  {loading ? (
                    <>
